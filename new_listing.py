...
from rsrcs.coin_lib_listings import limit_buy_token, keyboard_buy, keyboard_sell_new_listing
from rsrcs.coin_lib_pumps import keyboard_sell

COIN_NAME = 'DOGE'
DELAY = 0  # delay to update coin price again as soon as listing. 0 means no update
USDT_AMOUNT = 0.3
...
def main():
    ...
    keyboard_sell_new_listing(COIN_NAME, order_id)  # page-up -- limit sell, page-down -- market sell
